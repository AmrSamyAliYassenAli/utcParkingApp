...
namespace UTCAPPCMS.DAL.Migrations
{
    ...
    [Migration("20210204122149_init_UTCAPPCMS_UPDATE2")]
    partial class init_UTCAPPCMS_UPDATE2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UTCAPPCMS.DAL.Models.GroupPrivilage", b =>
                {
                    ...
                    b.Property<int?>("GroupIdNavigationId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PageIdNavigationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GroupIdNavigationId");

                    b.HasIndex("PageIdNavigationId");
            ...
            modelBuilder.Entity("UTCAPPCMS.DAL.Models.GroupPrivilage", b =>
                {
                    b.HasOne("UTCAPPCMS.DAL.Models.UserGroup", "GroupIdNavigation")
                        .WithMany("GroupPrivilage")
                        .HasForeignKey("GroupIdNavigationId");

                    b.HasOne("UTCAPPCMS.DAL.Models.FormPages", "PageIdNavigation")
                        .WithMany("GroupPrivilage")
                        .HasForeignKey("PageIdNavigationId");
                });

...
namespace UTCAPPCMS.DAL.Migrations
{
    ...
    [Migration("20210125143548_add-GpsLong")]
    partial class addGpsLong
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UTCAPPCMS.DAL.Models.TableCollectionTransaction", b =>
                {
                    ...
                    b.Property<int?>("PaymentsourceFkId")
                        .HasColumnName("paymentsource_FK_ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UTCAPPCMS.DAL.Models.TableTransactionDetail", b =>
                {
                    ...
                    b.Property<int?>("ParkingLocationIdId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParkingLocationIdId");
            ...
            modelBuilder.Entity("UTCAPPCMS.DAL.Models.TableCollectionTransaction", b =>
                {
                    b.HasOne("UTCAPPCMS.DAL.Models.PaymentSource", "PaymentsourceFk")
                        .WithMany("TableCollectionTransaction")
                        .HasForeignKey("PaymentsourceFkId")
                        .HasConstraintName("FK_Table_CollectionTransaction_PaymentSource")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("UTCAPPCMS.DAL.Models.TableTransactionDetail", b =>
                {
                    b.HasOne("UTCAPPCMS.DAL.Models.ParkingLocations", "ParkingLocationId")
                        .WithMany()
                        .HasForeignKey("ParkingLocationIdId");
